...
export default async function StartupDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!process.env.NEXT_PUBLIC_SUPABASE_URL) console.warn('[Startups] Missing NEXT_PUBLIC_SUPABASE_URL')
  if (!process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY) console.warn('[Startups] Missing NEXT_PUBLIC_SUPABASE_ANON_KEY')

  let article: StartupNews | null = null
  let related: StartupNews[] = []
